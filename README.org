...
| ~os.stat(f)~                  | ~(file-attributes f)~                                                                                       | ~stat~ and ~file-attributes~ are not isomorphic.                                    |
...
| ~os.path.splitext(f)~         | ~(list (file-name-concat (file-name-directory p) (file-name-base p)) (concat "." (file-name-extension p)))~ | ~splitext~ will include full path, ~file-name-base~ will use ~file-name-nondirectory~ |
