...
#+begin_example
p: string describing a path
f: string describing a filename
d: string describing a directory
e: string describing an extension
#+end_example


| Python                      | Elisp                                                                                                     | Notes                                                                           |
|-----------------------------+-----------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------|
| ~os.listdir(d)~               | ~(directory-files p)~                                                                                       |                                                                                 |
...
| ~os.path.join(p1, p2)~        | ~(file-name-concat p1 p2)~                                                                                  |                                                                                 |
...
| ~os.path.split(p)[1]~         | ~(file-name-nondirectory p)~                                                                                |                                                                                 |
| ~os.path.split(p)[0]~         | ~(file-name-directory f)~                                                                                   |                                                                                 |
